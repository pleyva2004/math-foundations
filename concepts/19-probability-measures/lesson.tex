...
Before the axioms, the running picture: a \emph{fair six-sided die}.
Take $\Om = \{1, 2, 3, 4, 5, 6\}$ and $\F = 2^{\Om}$ (every subset is an event).
Define $P(\{i\}) = 1/6$ for each face $i$, and extend by addition:
$P(A) = |A|/6$.
Then the three Kolmogorov axioms are visible at a glance:
(K1) $P(A) \geq 0$ since $|A| \geq 0$;
(K2) $P(\Om) = 6/6 = 1$;
(K3, finite case) for disjoint events the counts add, so e.g.
$P(\{1,2\}) = 2/6 = 1/6 + 1/6 = P(\{1\}) + P(\{2\})$.
Every formal manoeuvre below is just a careful version of what already works for the die.
...
\begin{enumerate}
    ...
    \]
    \emph{Read aloud:} ``P of the union from $n=1$ to infinity of $A_n$ equals the sum from $n=1$ to infinity of P of $A_n$.''
\end{enumerate}
\end{definition}
...
\]
\emph{Read aloud:} ``P of A union B equals P of A plus P of B minus P of A intersect B.''
\end{theorem}
...
\end{equation}
\emph{Read aloud:} ``P of A union B equals P of A plus P of B minus A.''
...
\]
\emph{Read aloud:} ``P of B equals P of B intersect A plus P of B minus A.''
and rearranging gives
\begin{equation}\label{eq:step2}
    P(B \setminus A) \;=\; P(B) - P(A \cap B).
\end{equation}
\emph{Read aloud:} ``P of B minus A equals P of B minus P of A intersect B.''
...
\]
\emph{Read aloud:} ``P of A union B equals P of A plus the quantity P of B minus P of A intersect B, which equals P of A plus P of B minus P of A intersect B.''
\end{proof}
...
\]
\emph{Read aloud:} ``P of the union from $i=1$ to $n$ of $A_i$ equals the sum from $k=1$ to $n$ of negative one to the $k$ plus one, times the sum over all $k$-element index subsets $i_1 < \cdots < i_k$ of P of $A_{i_1}$ intersect dot dot dot intersect $A_{i_k}$.''
...
\]
\emph{Read aloud:} ``P of the union from $n=1$ to infinity of $A_n$ is less than or equal to the sum from $n=1$ to infinity of P of $A_n$.''
\end{proposition}
...
\]
\emph{Read aloud:} ``P of the union over $n$ of $A_n$ equals the sum over $n$ of P of $B_n$, which is less than or equal to the sum over $n$ of P of $A_n$.''
\end{proof}
