...
Before any abstraction, picture a single roll of a fair six-sided die. The
\emph{sample space} --- the set of every outcome that could occur --- is
\[
\Omega \;=\; \{1, 2, 3, 4, 5, 6\}.
\]
\emph{Read aloud:} Omega equals the set containing 1, 2, 3, 4, 5, and 6.
The event ``the roll is even'' is the subset
\[
A \;=\; \{2, 4, 6\} \;\subseteq\; \Omega.
\]
\emph{Read aloud:} A equals the set containing 2, 4, and 6, which is a subset of Omega.
Under the uniform probability measure, $P(A) = 3/6 = 1/2$. Everything that
follows generalises this picture.
...
\]
\emph{Read aloud:} Two to the Omega equals the set of all A such that A is a subset of Omega.
\end{definition}
...
\]
\emph{Read aloud:} The cardinality of two to the Omega equals two to the n plus two to the n, which equals two times two to the n, which equals two to the n plus one.
